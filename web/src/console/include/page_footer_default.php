...
<footer class="main-footer">
    <div class="unselectable" id="footer">
        ...
        <strong>Copyright &copy; <?php echo date("Y"); ?>
            <a href="https://www.hutoma.ai" tabindex="-1">Hu:toma</a>.</strong> All rights reserved.
    </div>
<?php
$intercomAppId  = \hutoma\config::getIntercomAppId();

if(\hutoma\sessionObject::isLoggedIn()) {
    $userDetails = \hutoma\sessionObject::getCurrentUserInfo();
    if ($intercomAppId != null && isset($app_id)) {?>
        <script>
