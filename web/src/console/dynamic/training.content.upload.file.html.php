<div class="box box-solid box-clean flat no-shadow unselectable" id="box_monitor">
    ...
    <div class="box-body">
        ...
        <div class="alert alert-dismissable flat alert-base no-margin" id="containerMsgAlertUploadFile" style="margin-bottom: 0px;">
            ...
            <span id="msgAlertUploadFile">Upload a plain text file with chat examples to begin training. Look at this
                <a data-toggle="modal" data-target="#sampleTrainingFile" onMouseOver="this.style.cursor='pointer'"> example</a>.
            </span>
        </div>
    </div>
