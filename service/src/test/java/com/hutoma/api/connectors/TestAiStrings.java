...
public class TestAiStrings {
    ...
    @Test
    public void testGetDefaultChatResponses_singleResponse() throws AiStrings.AiStringsException, Database.DatabaseException {
    ...
    @Test
    public void testGetDefaultChatResponses_multipleResponse() throws AiStrings.AiStringsException, Database.DatabaseException {
    ...
    @Test()
    public void testGetDefaultChatResponses_noResponseInDb() throws AiStrings.AiStringsException, Database.DatabaseException {
    ...
    public void testGetDefaultChatResponses_dbException() throws AiStrings.AiStringsException, Database.DatabaseException {
    ...
    @Test(expected = AiStrings.AiStringsException.class)
    public void testgetRandomDefaultChatResponse_noResponseInDb() throws AiStrings.AiStringsException, Database.DatabaseException {
        when(this.fakeDatabase.getAI(any(), any(), any())).thenReturn(getAi(Collections.emptyList()));
        this.aiStrings.getRandomDefaultChatResponse(DEVID_UUID, AIID);
    }

    @Test(expected = AiStrings.AiStringsException.class)
    public void testgetRandomDefaultChatResponse_dbException() throws AiStrings.AiStringsException, Database.DatabaseException {
        when(this.fakeDatabase.getAI(any(), any(), any())).thenThrow(Database.DatabaseException.class);
        this.aiStrings.getRandomDefaultChatResponse(DEVID_UUID, AIID);
    }
}
