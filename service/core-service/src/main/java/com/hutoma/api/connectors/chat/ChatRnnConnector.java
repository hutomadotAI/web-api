...
public class ChatRnnConnector extends ChatBackendConnector {
    ...
    @Inject
    public ChatRnnConnector(final JerseyClient jerseyClient, final Tools tools, final Config config,
                            final TrackedThreadSubPool threadSubPool, final ILogger logger,
                            final JsonSerializer serializer, final RnnServicesConnector controllerConnector,
