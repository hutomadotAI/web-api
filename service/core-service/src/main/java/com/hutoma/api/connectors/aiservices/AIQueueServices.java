...
public class AIQueueServices extends ServerConnector {
    ...
    private void stopTrainingIfActive(final BackendStatus backendStatus, final BackendServerType serverType,
                                      final BackendServicesConnector backendConnector,
                                      final UUID devid, final UUID aiid,
        ...
        Map<String, ServerTrackerInfo> map = backendConnector.getVerifiedEndpointMap();
        ...
        if (status != null) {
            ...
            if (setDbStatus) {
                ...
                if (newStatus != null) {
                    ...
                    this.databaseAiStatusUpdates.updateAIStatus(serverType, aiid, newStatus,
    ...
    void userActionUpload(final BackendStatus backendStatus, BackendServerType serverType,
                          BackendServicesConnector backendConnector, UUID devid, UUID aiid)
            throws DatabaseException, AiServicesException {
        // send a stop training command if necessary
        stopTrainingIfActive(backendStatus, serverType, backendConnector, devid, aiid, false);
    ...
    void userActionStopTraining(final BackendStatus backendStatus, final BackendServerType serverType,
        ...
        stopTrainingIfActive(backendStatus, serverType, backendConnector, devid, aiid, true);
    }
