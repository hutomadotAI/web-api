    ...
    <div id="collapseKEYS" class="panel-collapse collapse">
        <div class="box-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="input-group">
                        <span class="input-group-addon text-white" style="width:90px; background-color: #2E3032;">Dev Key</i></span>
                        ...
                        <span class="input-group-addon text-white" style="background-color: #2E3032; data-clipboard-action="copy" data-toggle="tooltip"  data-clipboard-target="#devkey" id="devkeytooltip" title="copy to clipboard" onclick="copyToClipboard('devkey')"><i class="fa fa-clipboard"></i></span>
                    </div>
                </div>
            </div>
            <p></p>
            <div class="row">
                <div class="col-md-12">
                    <div class="input-group">
                        <span class="input-group-addon text-white" style="width:90px; background-color: #2E3032;">Client Key</i></span>
                        ...
                        <span class="input-group-addon text-white" style="background-color: #2E3032; data-clipboard-action="copy" data-toggle="tooltip"  data-clipboard-target="#clikey" id="clikeytooltip" title="copy to clipboard" onclick="copyToClipboard('clikey')"><i class="fa fa-clipboard"></i></span>
                    </div>
                </div>
            </div>
