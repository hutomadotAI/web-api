 <div class="box box-solid box-clean flat no-shadow" >
    ...
    <div class="box-body no-margin" id="boxAction" style="padding-top: 0;">
        ...
        <div class="alert alert-dismissable flat alert-base" id="containerMsgAlertIntentVariable">
            ...
            <span id="msgAlertIntentVariable">Set Intens parametere bla bla bla bla.</span>
        </div>
                     ...
                     <section class="content-info" >
                         <div class="box-body">
                             <dl class="dl-horizontal" style="text-align:justify">
                                 Intent variables are entities that you will want the AI to know before it flags you that the intent is fulfilled.
