<div class="box box-solid box-clean flat no-shadow">
   ...
   <i class="fa fa-video-camera text-red"></i>
   <h3 class="box-title">Video Tutorial</h3>
    <a data-toggle="collapse"  href="#collapseTutorial" tabindex="-1">
   ...
   <div class="box-body">
        <div id="collapseTutorial" class="panel-collapse collapse">
         <div class="box-body">
        ...
        <p></p>
                ...
                <iframe src="//www.youtube.com/embed/N4IMIpgUVis?controls=1&hd=1&enablejsapi=1" frameborder="0" allowfullscreen>
                </iframe>
                </div>
                </div>
                </div>
