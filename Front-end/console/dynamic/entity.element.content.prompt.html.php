 <div class="box box-solid box-clean flat no-shadow">
    ...
    <div class="box-header with-border ">
        ...
        <h3 class="box-title"><?php echo $_POST['entity']?><span class="text-sm text-gray" style="padding: 0px 3px 0px 3px;"> > </span> Prompt</h3>
     ...
     <div class="box-body no-margin" id="boxPrompt"  style="padding-top: 0px;">
            <div class="row">
                <div class="col-md-12">
                    <h5 class="box-title">
