...
<select class="form-control select" name="ai_language" id="ai_language" style="width: 100%;">
  ...
  <option disabled="disabled">中文 (廣東話)</option>
  <option disabled="disabled">中文 (简体)</option>
