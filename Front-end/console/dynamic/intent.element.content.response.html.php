<div class="box box-solid box-clean flat no-shadow" >
                ...
                <section class="content-info" >
                    <div class="box-body">
                        <dl class="dl-horizontal"  style="text-align:justify">
                            Intent responsse are a collection of examples bla bla bla bla bla bla bla.
                        </dl>
                    </div>
                </section>
                <p></p>
    ...
    <div class="box-body no-margin" id="boxIntentResponse"  style="padding-top: 0;">
            ...
            <div class="col-md-12">
                <h5 class="box-title">
                    <div class="input-group no-margin">
                        <input type="text" class="form-control flat no-shadow" id="intent-response" name="intent-response" placeholder="Add a sample response" onkeyup="checkIntentResponseCode(this,event.keyCode)"  style="width: 96%;">
        ...
        <div class="alert alert-dismissable flat alert-base" id="containerMsgAlertIntentResponse">
