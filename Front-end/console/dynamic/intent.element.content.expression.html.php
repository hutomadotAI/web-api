            ...
            <div class="col-md-12">
                <h5 class="box-title">
                    <div class="input-group no-margin">
                        <input type="text" class="form-control flat no-shadow" id="user-expression" name="user-expression" placeholder="Add a sample user expression" onkeyup="checkExpressionCode(this,event.keyCode)"  style="width: 96%;">
