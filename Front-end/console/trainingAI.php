...
<div class="wrapper">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="active">
                <a href="#">
                    <i class="fa fa-user text-orange"></i><span><?php echo $_SESSION['current_ai_name']; ?></span><i class="fa fa-ellipsis-v pull-right"></i>
                </a>
                <ul class="treeview-menu">

                    <li class="active"><a href="#"><i class="fa fa-graduation-cap text-light-blue"></i> <span>training</span></a></li>
